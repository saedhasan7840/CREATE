...
"""
os.system('clear')
print('             \x1b[38;5;46m WELCOME TO AK-SAED WORLD          ')
time.sleep(5)
#------------------[ PROXY SERVER ]-------------------#
def load_proxies():
...
logo=(f"""\033[1;32m
       ...
       db         88      a8P         ad88888ba         db         88888888888  88888888ba,    
      d88b        88    ,88'         d8"     "8b       d88b        88           88      `"8b   
     d8'`8b       88  ,88"           Y8,              d8'`8b       88           88        `8b  
    d8'  `8b      88,d88'            `Y8aaaaa,       d8'  `8b      88aaaaa      88         88  
   d8YaaaaY8b     8888"88,   aaaaaaaa  `"""""8b,    d8YaaaaY8b     88"""""      88         88  
  d8""""""""8b    88P   Y8b  """"""""        `8b   d8""""""""8b    88           88         8P  
 d8'        `8b   88     "88,        Y8a     a8P  d8'        `8b   88           88      .a8P   
d8'          `8b  88       Y8b        "Y88888P"  d8'          `8b  88888888888  88888888Y"'    
                                                                                                                                                                                           
\033[1;34m────────────────────────────────────────────────────────
 \033[1;32m[\033[1;31m–\033[1;32m] AUTHOR   : AK-SAED
 \033[1;32m[\033[1;31m–\033[1;32m] SERVICE  : {rrrrrrrr}FREE\033[;0m┼{____Version____}
...
def auto_create_fb_method_1_() -> None:
    ...
    for make in range(50000):
        ...
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}AK-SAED-XD\033[1;37m]<×>[{make+1}|\033[1;32m{oks}\033[1;37m]> ');sys.stdout.flush()
        #sys.stdout.write(f"\r\r\033[1;37m[AK-SAED-CREATE] {make+1}\033[1;37m|\033[1;32mOK-:{len(oks)}\033[1;37m");sys.stdout.flush()
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}AK-SAED-XD\033[1;37m]<×>[{make+1}|\033[1;32m{len(ok)}\033[1;37m]> ');sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
